      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3">
        <div className="pb-4 border-b border-primary sm:pb-6 lg:pb-0 lg:border-b-0 lg:pr-6 lg:border-r">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Создаю основу для сайта, включая верстку, стилизацию и создание
            интерактивных элементов, используя современные инструменты для
            разработки.
          </p>
        </div>
        <div className="py-4 border-b border-primary sm:py-6 lg:py-0 lg:px-6 lg:border-b-0 lg:border-r">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Подключаю внешние сервисы для аналитики, карт, оплаты, отправки
            данных на почту или в Telegram, а также другие полезные функции.
          </p>
        </div>
        <div className="pt-4 sm:pt-6 lg:pt-0 lg:pl-6">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Полная настройка: размещение сайта на хостинге, подключение домена,
            настройка SSL-сертификатов и обеспечение стабильной работы сайта.
          </p>
        </div>
      </div>
    </section>
