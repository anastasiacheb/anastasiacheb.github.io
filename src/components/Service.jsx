      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3">
        <div className="pb-4 border-b border-primary sm:pb-6 lg:pb-0 lg:border-b-0 lg:pr-6 lg:border-r">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Превращаю дизайн в адаптивный и быстрый сайт с точным соответствием
            макету, интерактивными элементами, плавными анимациями и корректной
            работой на разных устройствах и в популярных браузерах.
          </p>
        </div>
        <div className="py-4 border-b border-primary sm:py-6 lg:py-0 lg:px-6 lg:border-b-0 lg:border-r">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Реализую логику корзин, checkout-процессов, калькуляторов,
            фильтрации и сортировки данных, а также форм с валидацией,
            маскированием полей и обработкой пользовательских действий.
          </p>
        </div>
        <div className="pt-4 sm:pt-6 lg:pt-0 lg:pl-6">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Добавляю возможность управления контентом через CMS, настраиваю
            отправку данных из форм, подключаю API и внешние сервисы, платежи,
            аналитику, карты и публикую сайт на хостинге.
          </p>
        </div>
      </div>
    </section>
