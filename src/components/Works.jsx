...
const projects = [
  {
    ...
    text: 'Многостраничный адаптивный интернет-магазин с динамической генерацией страниц категорий и товаров. Реализованы корзина с сохранением данных и расчетом стоимости, а также многоступенчатый checkout-процесс. Создана компонентная архитектура с переиспользуемыми элементами и выполнена оптимизация производительности приложения. UI-компоненты (селекты, date picker) адаптированы под стиль проекта с помощью shadcn/ui. Добавлены скролл-эффекты и интерактивные состояния для создания плавного и цельного пользовательского опыта.',
