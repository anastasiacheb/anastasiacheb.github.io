...
const projects = [
  ...
  },
  {
    ...
    text: 'Административная панель для управления интернет-магазином антикварной мебели. \n\n Реализованы таблицы товаров и заказов с поиском, сортировкой, фильтрацией и получением данных из базы данных, а также редактирование, добавление и удаление товаров. Предусмотрена валидация данных в формах добавления и редактирования товаров. Интерфейс построен с помощью UI-компонентов.',
    tags: [
      'React',
      'shadcn/ui',
      'Tailwind',
