...
const projects = [
  {
    ...
    text: 'Многостраничный адаптивный интернет-магазин антикварной мебели с динамической генерацией страниц категорий и товаров. \n\n Реализованы корзина с сохранением данных и расчетом стоимости, а также многоступенчатый checkout-процесс. UI-компоненты (селекты, date picker) адаптированы под стиль проекта с помощью shadcn/ui. Добавлены скролл-эффекты и интерактивные состояния.',
  ...
  },
  {
    ...
    text: 'Административная панель для управления интернет-магазином антикварной мебели. \n\n Реализованы таблицы товаров и заказов с поиском, сортировкой, фильтрацией и получением данных из базы, а также редактирование, добавление и удаление товаров. Предусмотрена валидация данных в формах добавления и редактирования товаров. Интерфейс построен с помощью UI-компонентов.',
    tags: [
      'React',
      'shadcn/ui',
      'Tailwind',
  ...
  },
  {
    image: 'neuros.png',
    title: 'Neuros',
    text: 'Адаптивный лендинг для сервиса AI-аналитики с дополнительной страницей приложений. \n\nНастроено управление контентом с помощью headless CMS. Добавлена поддержка темной темы в зависимости от системных настроек пользователя.',
